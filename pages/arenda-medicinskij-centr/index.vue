<script setup>
    ...
    useHead({
        title: 'аренда медицинского центра, аренда помещений под медицинский центр медцентр, снять медицинское помещение в москве.',
        meta: [
            { name: 'keywords', content: 'аренда медцентр, аренда медицинского центра, аренда помещения под медицинский центра, снять медцентр, снять медицинское помещение.' },
            { name: 'description', content: `аренда медицинского центра, аренда помещений под медицинский центр медцентр, снять медицинское помещение в москве.` }
        ]
    })
...
<template>
    <div style="padding-left: 1px;padding-right: 1px;">
        ...
        <div style="display: flex;">
            ...
            <div>
                <h1>аренда медицинского центра, аренда помещений под медицинский центр медцентр, снять медицинское помещение в москве</h1>							
