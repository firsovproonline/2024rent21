...
useHead({
    title: 'аренда помещений под гостиницу, хостел, общежитие в Москве.',
    meta: [
        { name: 'keywords', content: 'аренда помещений под гостиницу, хостел, общежитие в Москве.' },
...
const route = useRoute()
    ...
    const rowsGet = ref({})
    const nextUrl = '/arenda-gostinitsa'
    const findQuery = {
        page: page.value,
        perPage: 10,
        //TIP: 'Офис',
