<script setup>
    ...
    useHead({
        title: 'Продажа помещений под кафе, Ресторан  Продать помещение под кафе и Ресторан .',
        meta: [
            { name: 'keywords', content: 'Продажа помещений под кафе, Ресторан, Снять помещение под кафе и Ресторан .' },
            { name: 'description', content: `Продажа помещений под кафе и Ресторан От Собственников по всей Москве БЕЗ КОМИССИИ! Помогаем купить помещений под кафе и Ресторан БЕЗ КОМИССИЙ!.` }
        ]
    })
    ...
    const rowsGet = ref({})
    const nextUrl = '/prodazha-kafe-restoran'
...
<template>
    <div style="padding-left: 1px;padding-right: 1px;">
        ...
        <div style="display: flex;">
            ...
            <div>
                <h1>Продажа помещений под кафе, Ресторан, Продать помещение под кафе и Ресторан.</h1>							
