<script setup>
    ...
    const rowsGet = ref({})
    rowsGet.value = await $fetch( `/api/ymap`, {
      method: 'GET',
      params: props.filter
    })
    ...
    onMounted((w) => {
        setTimeout(()=>{
            ...
            rows.value.forEach(row => {
                    ...
                    markerElement.innerHTML=`    <svg style="width: 100%;height: 100%;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" id="Layer_1" width="800px" height="800px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
<g>
	<g>
...
`
                    ...
                    //markerElement.innerText = row.LAT;
                    mapY.addChild(new YMapMarker({type: 'buildings',coordinates: [row.LAT, row.LNG]}, markerElement));        
